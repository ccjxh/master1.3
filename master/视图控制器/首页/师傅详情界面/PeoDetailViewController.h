...
@interface  PeoDetailViewController : RootViewController<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,TencentSessionDelegate,WXApiDelegate,UITextFieldDelegate>
...
@property(nonatomic)NSMutableArray*allSkills;//个人的全部技能数组
