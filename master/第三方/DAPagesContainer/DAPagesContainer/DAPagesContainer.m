...
- (void)setUp
{
    ...
    _topBarItemLabelsFont = [UIFont systemFontOfSize:16];
        ...
        [UIView animateWithDuration:(animated) ? 0.3 : 0. delay:0. options:UIViewAnimationOptionBeginFromCurrentState animations:^
         {
             ...
             [nextSelectdItem setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
         } completion:nil];
    } else {
...
//            [previosSelectedItem setTitleColor:[UIColor col:0.6 + 0.4 * (1 - fabsf(ratio))
