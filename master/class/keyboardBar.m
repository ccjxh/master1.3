...
- (void)setupSubviews
{
    ...
    if (!self.moreView) {
        self.moreView = [[keyboardMoreView alloc] initWithFrame:CGRectMake(0, (kVerticalPadding * 2 + kInputTextViewMinHeight), self.frame.size.width, 80) type:ChatMoreTypeGroupChat];
